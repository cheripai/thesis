...
from data import v2, v1, AnnotationTransform, LettuceDetection, detection_collate, dataroot, CLASSES
...
parser.add_argument('--voc_root', default=dataroot, help='Location of VOC root directory')
